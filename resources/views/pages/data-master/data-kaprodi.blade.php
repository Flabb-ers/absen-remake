    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Data Kaprodi</span>
            </div> 
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td class="text-center" colspan="7">Kaprodi belum ditambahkan</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                ...
                <div class="modal-body">
                    <form id="tambahForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="prodi" name="prodis_id">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="mb-3">
                            <label for="nama" class="form-label">Dosen <span style="color: red;">*</span></label>
                            <select class="form-select" id="edit_nama" name="nama">
                                <option selected value="">--Dosen--</option>
                                @foreach ($dosens as $dosen)
                                    <option value="{{ $dosen->nama }}">{{ $dosen->nama }}</option>
                                @endforeach
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="edit_prodi" name="prodis_id">
                                <option selected value="">--Prodi--</option>
                                @foreach ($prodis as $prodi)
                                    <option value="{{ $prodi->id }}">{{ $prodi->nama_prodi }}</option>
                                @endforeach
                        ...
                        <div class="mb-3">
                            <label for="edit_noTelephone" class="form-label">Nomor WhatsApp <span
                                    style="color: red;">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="edit_noTelephone"
                                name="edit_noTelephone" placeholder="Nomor WhatsApp">
