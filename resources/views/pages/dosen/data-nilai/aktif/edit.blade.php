                                ...
                                <div class="col-md-5 col-12">
                                    <ul class="list-unstyled">
                                        <li class="d-flex align-items-center">
                                            ...
                                            <span>{{ $aktifs->first()->matkul->nama_matkul }}</span>
                                        </li>
                                        <li class="d-flex align-items-center mt-2">
                                            <span style="width: 140px;">Dosen</span>
                                            <span style="margin-right: 5px;">:</span>
                                            <span>{{ $aktifs->first()->jadwal->dosen->nama }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-5 offset-md-2 col-12">
                                    <ul class="list-unstyled">
                                        <li class="d-flex align-items-center">
                                            ...
                                            <span style="margin-right: 5px;">:</span>
                                            <span>{{ $aktifs->first()->kelas->prodi->nama_prodi }}</span>
                                        </li>
                                        <li class="d-flex align-items-center mt-2">
                                            <span style="width: 140px;">Kelas</span>
                                            <span style="margin-right: 5px;">:</span>
                                            <span>{{ $aktifs->first()->kelas->nama_kelas }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input type="number" name="nilai[]" id="nilai_{{ $mahasiswa->id }}"
                                                    value="{{ $aktifs->where('mahasiswa_id', $mahasiswa->id)->first()->nilai ?? '' }}"
